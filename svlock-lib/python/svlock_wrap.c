...
/*-----------------------------------------------
  ...
  ------------------------------------------------*/
#if PY_VERSION_HEX >= 0x03000000
#  define SWIG_init    PyInit__svlock

#else
#  define SWIG_init    init_svlock

#endif
#define SWIG_name    "_svlock"
...
SWIGINTERN PyObject *_wrap_svlock_shm_open(PyObject *self, PyObject *args) {
  ...
  if (!SWIG_Python_UnpackTuple(args, "svlock_shm_open", 0, 0, 0)) SWIG_fail;
  result = (int)svlock_shm_open();
  resultobj = SWIG_From_int((int)(result));
  return resultobj;
fail:
  return NULL;
...
SWIGINTERN PyObject *_wrap_svlock_unlink(PyObject *self, PyObject *args) {
  PyObject *resultobj = 0;
  int result;
  
  if (!SWIG_Python_UnpackTuple(args, "svlock_unlink", 0, 0, 0)) SWIG_fail;
  result = (int)svlock_unlink();
  resultobj = SWIG_From_int((int)(result));
  return resultobj;
fail:
  return NULL;
...
SWIGINTERN PyObject *_wrap_svlock_release_all(PyObject *self, PyObject *args) {
  PyObject *resultobj = 0;
  int result;
  
  if (!SWIG_Python_UnpackTuple(args, "svlock_release_all", 0, 0, 0)) SWIG_fail;
  result = (int)svlock_release_all();
  resultobj = SWIG_From_int((int)(result));
  return resultobj;
fail:
  return NULL;
...
SWIGINTERN PyObject *_wrap_svlock_close_all(PyObject *self, PyObject *args) {
  ...
  if (!SWIG_Python_UnpackTuple(args, "svlock_close_all", 0, 0, 0)) SWIG_fail;
  result = (int)svlock_close_all();
  resultobj = SWIG_From_int((int)(result));
  return resultobj;
fail:
  return NULL;
...
SWIGINTERN PyObject *_wrap_svlock_shm_close(PyObject *self, PyObject *args) {
  PyObject *resultobj = 0;
  int result;
  
  if (!SWIG_Python_UnpackTuple(args, "svlock_shm_close", 0, 0, 0)) SWIG_fail;
  result = (int)svlock_shm_close();
  resultobj = SWIG_From_int((int)(result));
  return resultobj;
fail:
  return NULL;
